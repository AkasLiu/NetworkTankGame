...
public class Lua_Common_Protocol_StartGameProtocol : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			Common.Protocol.StartGameProtocol o;
			if(argc==1){
				o=new Common.Protocol.StartGameProtocol();
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
				...
				o=new Common.Protocol.StartGameProtocol(a1,a2,a3,a4,a5,a6,a7);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
