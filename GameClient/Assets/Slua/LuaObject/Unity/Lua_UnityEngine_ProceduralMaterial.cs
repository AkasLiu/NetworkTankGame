...
public class Lua_UnityEngine_ProceduralMaterial : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GetProceduralString(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			System.String a1;
			checkType(l,2,out a1);
			var ret=self.GetProceduralString(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int SetProceduralString(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			System.String a2;
			checkType(l,3,out a2);
			self.SetProceduralString(a1,a2);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int set_cacheSize(IntPtr l) {
		try {
			...
			v = (UnityEngine.ProceduralCacheSize)LuaDLL.luaL_checkinteger(l, 2);
			self.cacheSize=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public int set_substanceProcessorUsage(IntPtr l) {
		try {
			...
			v = (UnityEngine.ProceduralProcessorUsage)LuaDLL.luaL_checkinteger(l, 2);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,GetProceduralString);
		addMember(l,SetProceduralString);
