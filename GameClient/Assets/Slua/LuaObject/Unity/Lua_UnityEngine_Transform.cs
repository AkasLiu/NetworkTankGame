...
public class Lua_UnityEngine_Transform : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int AddClickEventListener(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			ClickEventTriggerListener.EventPosDelegate a2;
			checkDelegate(l,2,out a2);
			self.AddClickEventListener(a2);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,AddClickEventListener);
